...
class WordCounterTest {
  ...
  @Test
  void givenTextAndWordWhenCountOccurencesThenReturnHowManyOcurrencesoOfTheWordInTheText() {
    val text = "Hola, este es mi texto de prueba; ¡hola prueba!";
    val word = "Hola";

    Long count = wordCounter.countWord(text, word);
